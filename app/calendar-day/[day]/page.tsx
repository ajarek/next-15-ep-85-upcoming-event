      ...
      <div className='flex flex-wrap gap-4'>
        {items
          ...
          .map((item) => (
            ...
            >
              <p>
                <span className='text-gray-300 text-sm'>data:</span> {item.date}
              </p>
              <p>
                <span className='text-gray-300 text-sm'>wydarzenie:</span>{' '}
                {item.event}
              </p>
              <p>
              ...
              <p>
                <span className='text-gray-300 text-sm'>koniec:</span>{' '}
                {item.timeOff}
              </p>
              <p>
